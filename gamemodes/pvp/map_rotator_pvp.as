...
#include "peaceful_last_base_pvp.as"

#include "player_score.as"

class MapRotatorPvp : MapRotator {
    ...
    MapRotatorPvp(GameModePvp@ metagame, PlayerScore@ playerScore) {
        super();

        @m_metagame = metagame;
        @m_playerScore = playerScore;
        m_playerScore.setupMapRotator(this);
    ...
    //     // any faction win, to next map, exec handleMatchEndEvent
    // }
    ...
    protected void handleMatchEndEvent(const XmlElement@ event) {
        _log("Function -> handleMatchEndEvent");
        // prepare for lost battle, grey won
        int factionId = 1;

        m_playerScore.announceScore();
        m_playerScore.resetAllScore();

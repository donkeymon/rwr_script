...
class Stage {
    // common game settings from GameModePvp, passed in in constructor
    ...
    const XmlElement@ getStartGameCommand(GameModePvp@ metagame, float completionPercentage = 0.5) const {
